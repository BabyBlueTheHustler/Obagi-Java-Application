...
// the next() metods read the input delimited by white spaces
// the nextLine() mmethod reads the input including white spaces  
public class UserInput{
	public static void main(String[] args){
		...
		System.out.printf("Hey %s, do you love Java? %b %n", name, isJava);
